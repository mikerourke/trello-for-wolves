 ...
 *    Action types to include in the response, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiParam {Boolean} [actionsEntities=false] Include <code>entities</code> data in the response.
 * @apiParam {Boolean} [actionsDisplay=false] Include <code>display</code> data in the response.
 * @apiParam {String="list","count","minimal"} [actionsFormat='"list"'] Format for returning
 *    actions in the response.
 * @apiParam {String="lastView",date,null} [actionsSince] Starting date for actions to include in
 *    the response.
 * @apiParam {number{0-1000}} [actionsLimit=50] Limit to impose on actions included in response.
 * @apiParam {String="all","data","date","idMemberCreator","type"} [actionFields='"all"']
 *    Action fields to include in the response, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiParam {Boolean} [actionMember=true] Indicates if member fields should be included in
 ...
 *    Member fields for actions to include in response, can either be <code>"all"</code> or an
 *    array of field names.
 * @apiParam {Boolean} [actionMemberCreator=true] Indicates if member creator fields should be
 ...
 *    Member creator fields for actions to include in response, can either be <code>"all"</code>
 ...
 *    Card fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 * @apiParam {Boolean=true,false,"cover"} [cardAttachments=true]
 *    If <code>true</code>, include all attachments, if <code>false</code>, include none, and if
 *    <code>"cover"</code>, include only card cover attachments.
 * @apiParam {String="all","bytes","date","edgeColor","idMember","isUpload","mimeType","name","previews","url"} [cardAttachmentFields='"all"']
 *    Card attachment fields to include in the response, can either be <code>"all"</code> or an
 *    array of field names.
 * @apiParam {String="all","none"} [cardChecklists='"none"'] Checklists to include in response.
 * @apiParam {Boolean} [cardPluginData=false] Indicates if card plugin data should be included in
 *    response.
 * @apiParam {Boolean} [cardStickers=false] Indicates if card stickers data should be included in
 *    response.
 * @apiParam {String="mine","none"} [boardStars='"none"'] Board stars to include in response.
 * @apiParam {String="all","none"} [labels='"none"'] Labels to include in response.
 * @apiParam {String="all","color","idBoard","name","uses"} [labelFields='"all"']
 *    Label fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 * @apiParam {Number{0-1000}} [labelsLimit=50] Maximum number of labels to show in response.
 * @apiParam {String="all","closed","none","open"} [list='"all"']
 *    Limit response to include specified statuses, can either be <code>"all"</code> or an array
 *    of field names.
 * @apiParam {String="all","closed","idBoard","name","pos","subscribed"} [listFields='"all"']
 *    List fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 * @apiParam {String="all","active","admin","deactivated","me","none","normal"} [memberships='"none"']
 *    Memberships to include in the response.
 * @apiParam {Boolean} [membershipsMember=true] Indicates if membership member fields should be included in response.
 ...
 *    Membership member fields to include in response, can either be <code>"all"</code> or an array
 *    of field names.
 ...
 *    Invited member fields to include in response, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiParam {Boolean} [pluginData=false] Indicates if plugin data should be included in response.
 ...
 *    Checklist fields to include in response, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiParam {String="all","closed","none","open"} [list='"all"']
 ...
 *    <code>"all"</code> or an array of field names.
 * @apiParam {Boolean} [organization=false] Include <code>organization</code> data in the response.
 ...
 *    Organization fields to include in the response, can either be <code>"all"</code> or an array
 *    of field names.
 ...
 * @apiParam {Boolean} [organizationPluginData=false] Indicates if organization plugin data should
 *    be included in response.
 * @apiParam {Boolean} [myPrefs=false] Indicates if <code>myPrefs</code> data should be included
 *    in response.
 * @apiParam {Boolean} [tags=false] Indicates if tags data should be included in response.
 ...
 *    Board fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 ...
 * @apiPermission read
 *
 * @apiParam {Boolean} [display=false] Include <code>display</code> data in the response.
 * @apiParam {Boolean} [entities=false] Include <code>entities</code> data in the response.
 ...
 *    Action fields to include in the response, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiParam {number{0-1000}} [limit=50] Limit to impose on actions included in response.
 * @apiParam {String="list","count","minimal"} [format='"list"'] Format for returning actions in
 *    the response.
 * @apiParam {String="lastView",date,null} [since] Starting date for actions to include in
 *    the response.
 * @apiParam {Date} [before] End date for actions to include in the response.
 * @apiParam {number{0-1000}} [page=0] Page of data to return in response.
 ...
 *    Member fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 * @apiParam {Boolean} [memberCreator=true] Indicates if member creator fields should be included in response.
 * @apiParam {String="all","avatarHash","bio","bioData","confirmed","fullName","idPremOrgsAdmin","initials","memberType","products","status","url","username"} [memberCreatorFields='"avatarHash,fullName,initials,username"']
 *    Member creator fields to include in response, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiExample {js} Example:
 ...
 * @apiPermission read
 *
 * @apiParam {String="mine","none"} [filter='"mine"'] Board stars to include in response.
 * @apiExample {js} Example:
 ...
 *
 * @apiParam {String="all","addAttachmentToCard","addChecklistToCard","addMemberToBoard","addMemberToCard","addMemberToOrganization","addToOrganizationBoard","commentCard","convertToCardFromCheckItem","copyBoard","copyCard","copyCommentCard","createBoard","createCard","createList","createOrganization","deleteAttachmentFromCard","deleteBoardInvitation","deleteCard","deleteOrganizationInvitation","disablePowerUp","emailCard","enablePowerUp","makeAdminOfBoard","makeNormalMemberOfBoard","makeNormalMemberOfOrganization","makeObserverOfBoard","memberJoinedTrello","moveCardFromBoard","moveCardToBoard","moveListFromBoard","moveListToBoard","removeChecklistFromCard","removeFromOrganizationBoard","removeMemberFromCard","unconfirmedBoardInvitation","unconfirmedOrganizationInvitation","updateBoard","updateCard","updateCard:closed","updateCard:desc","updateCard:idList","updateCard:name","updateCheckItemStateOnCard","updateChecklist","updateList","updateList:closed","updateList:name","updateMember","updateOrganization"} [actions='"all"']
 *    Action types to include in the response, can either be <code>"all"</code> or an array of field
 *    names.
 ...
 *    Attachment fields to include in the response, can either be <code>"all"</code> or an array
 *    of field names.
 * @apiParam {Boolean} [stickers=false] Indicates if sticker data should be included in the
 * response.
 * @apiParam {Boolean} [member=true] Indicates if member fields should be included in response.
 * @apiParam {String="all","avatarHash","bio","bioData","confirmed","fullName","idPremOrgsAdmin","initials","memberType","products","status","url","username"} [memberFields='"avatarHash,fullName,initials,username"']
 *    Member fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 * @apiParam {Boolean} [checkItemStates=true] Indicates if check item state data should be included
 *    in response.
 * @apiParam {String="all","none"} [checklists='"none"'] Checklists to include in response.
 * @apiParam {number{0-1000}} [limit=50] Limit to impose on actions included in response.
 * @apiParam {Date} [since] Starting date for actions to include in the response.
 * @apiParam {Date} [before] End date for actions to include in the response.
 ...
 *    Member creator fields for actions to include in response, can either be <code>"all"</code>
 *    or an array of field names.
 * @apiParam {Boolean} [members=true] Indicates if member fields should be included in response.
 * @apiParam {String="all","avatarHash","bio","bioData","confirmed","fullName","idPremOrgsAdmin","initials","memberType","products","status","url","username"} [memberFields='"avatarHash,fullName,initials,username"']
 *    Member fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 * @apiParam {Boolean} [checkItemStates=true] Indicates if check item state data should be included
 ...
 *    Card fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 * @apiParam {String="all","none"} [checkItems='"none"'] Checklist items to include in response.
 * @apiParam {String="all","name","nameData","pos","state","value"} [checkItemFields='"all"']
 *    Checklist item fields to include in response, can either be <code>"all"</code> or an array
 *    of field names.
 * @apiParam {String="all","idBoard","idCard","name","pos"} [fields='"all"']
 *    Checklist fields to include in response, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiParam {String="all","none"} [filter='"all"'] Checklist types to include in response.
 * @apiExample {js} Example:
 ...
 *    Label fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
 * @apiParam {Number{0-1000}} [limit=50] Number of records to limit for response.
 * @apiExample {js} Example:
 ...
 *    Member level types to include in the response
 * @apiParam {Boolean} [activity=false] Indicates if activity should be included in the response.
 *    This works for premium organizations only.
 * @apiExample {js} Example:
 ...
 *    <code>"cover"</code>, include only card cover attachments.
 * @apiParam {String="all","bytes","date","edgeColor","idMember","isUpload","mimeType","name","previews","url"} [attachmentFields='"all"']
 *    Attachment fields to include in the response, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiParam {Boolean} [member=true] Indicates if member fields should be included in response.
 * @apiParam {String="all","avatarHash","bio","bioData","confirmed","fullName","idPremOrgsAdmin","initials","memberType","products","status","url","username"} [memberFields='"avatarHash,fullName,initials,username"']
 *    Member fields to include in response, can either be <code>"all"</code> or an array of field
 ...
 *    in response.
 * @apiParam {String="all","none"} [checklists='"none"'] Checklist data to include in the response.
 * @apiParam {Boolean} [board=true] If <code>true</code>, include board data in the response.
 ...
 *    names.
 * @apiParam {String="all","closed","none","open"} [list='"all"']
 *    Limit response to include specified statuses, can either be <code>"all"</code> or an array of
 *    field names.
 * @apiParam {String="all","closed","idBoard","name","pos","subscribed"} [listFields='"all"']
 *    List fields to include in response, can either be <code>"all"</code> or an array of field
 *    names.
