 ...
 * @apiParam {String="count","list","minimal"} [format="list"] Format for displaying results in the
 *    response.
 * @apiParam {String} [since] Starting date for data to include in the response, can be a date,
 *    <code>null</code> or <code>"lastView"</code>.
 * @apiParam {Date} [before] Ending date for data to include in response, can be either a date or
 *    <code>null</code>.
 */
 ...
 *    Model types to limit search to, can either be <code>"all"</code> or an array of field names.
 */
