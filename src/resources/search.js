...
export default class Search extends BaseResource {
   ...
   *    Model types to limit values for, can either be <code>"all"</code> or an
   ...
   * "name","pinned","powerUps","prefs","shortLink","shortUrl","starred","subscribed",
   * "url"} [boardFields='["name", "idOrganization"]']
   ...
   * "manualCoverAttachment","name","pos","shortLink","shortUrl","subscribed",
   * "url"} [cardFields='"all"']
   ...
   *    Organization fields to include in the response, can either
